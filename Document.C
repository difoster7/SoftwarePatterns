...
Document_Impl::Document_Impl(void) : Node_Impl("", dom::Node::DOCUMENT_NODE), CompositeNode_Impl("", dom::Node::DOCUMENT_NODE, this)
{
	//CompositeNode_Impl::Node_Impl::document	= this;
}
