...
Director_State::Director_State(const std::string& filename, Builder_State* builder)
{
	...
	do
	{
		...
		state = state->handle(lastToken, currentToken, token, builder);
